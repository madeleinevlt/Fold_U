...
{
	print STDERR "=====================================================================================================\n";
	print STDERR "		COMPUTE WEIGHTS FOR SEQUENCES AND POSITIONS FROM MULTIPLE ALIGNEMENT\n";
    print STDERR "                    (method from HENIKOFF & HENIKOFF 1994)\n\n";
	print STDERR "=====================================================================================================\n";
    print STDERR "                    by jean-christophe.gelly\@univ-paris-diderot.fr\n";
    print STDERR "=====================================================================================================\n";
	print STDERR "Usage	: $0 <file alignment fasta>\n";
	print STDERR "=====================================================================================================\n\n";
	print STDERR "Options	 :	No options\n";
	print STDERR "=====================================================================================================\n\n";
...
#############
#Parse position
my @tab_aa=split('',"ABCDEFGHIJKLMNPQRSTVWXYZ-_");
#print "@tab_aa\n";
