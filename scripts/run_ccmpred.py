...
"""
    ...
    Arguments:
        ALN FILE                Path to the multiple alignment file generated by
                                the Upstream program (mfasta format)
"""
...
if __name__ == "__main__":
    ...
    # Multiple alignment file (mfasta format)
    ALN_FILE = ARGUMENTS["ALN"]

    PATH = ALN_FILE.split(".")[0]

    # Paths
    ALN_FILE_CLUSTAL = PATH + ".clustal"
    CCMPRED_OUTPUT = PATH + ".mat"
    if not os.path.isfile(CCMPRED_OUTPUT):
        ...
        print("The .mat file already exist.")
