...
png(filename=output, height=700, width=700)
  ...
  type_scores = list(ali, thr, blossum, ali_thr, thr_blossum, ali_thr_blossum)
  ...
  legend("bottomright", cex=1.2, lwd=3, col=colors, pch=4,
        c("alignment score", "threading score", "blossum score", "alignment + threading scores",
          "threading + blossum scores", "alignment + threading + blossum scores"))
dev.off()